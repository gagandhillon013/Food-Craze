...
import com.example.foodcraze.Callback.MyButtonClickListener;
...
public abstract class MySwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public class MyButton{
        ...
        public MyButton(Context context,String text,int txtSize, int imageResId,  int color, MyButtonClickListener listener) {
            this.text = text;
